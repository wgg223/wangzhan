...
> 当前版本：v7.5.0 ｜ 许可证：[GPL v3](./LICENSE)
...
- **在线表格**（Luckysheet 编辑器，功能接近 Excel：多 Sheet、公式、图表、条件格式；实时在线用户、锁定控制、自动保存 / Ctrl+S；CSV / Excel 导入，自动识别中文编码与分隔符；文档级权限：查看 / 编辑 / 下载 / 创建副本，权限申请与审批、站内通知）
